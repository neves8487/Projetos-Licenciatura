...
Repositório para guardar os principais trabalhos realizados ao longo da minha licenciatura em **Engenharia Informática**.
...
| **SI1** | Sistemas de Informação I — O objetivo consiste na análise do sistema de informação de uma empresa. A análise focou-se no mapeamento de processos, classificação de cada módulo, avaliação do alinhamento estratégico, na infraestrutura de TI e gestão de dados, de forma a identificar falhas e propor melhorias.| [`SI1.zip`](2ºAno/SI1/SI1.zip) |
